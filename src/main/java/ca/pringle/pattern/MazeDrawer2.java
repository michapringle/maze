...
public class MazeDrawer2 extends JFrame//Applet
{
    ...
    public MazeDrawer2(String title, int rowParam, int colParam, Set s) {
        super(title);
        ...
        sp.setPreferredSize(new Dimension(d.width, d.height));
